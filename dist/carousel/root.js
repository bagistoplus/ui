 ...
 */
export class UICarousel extends ZagRootElement {
    ...
    machineProps() {
        ...
        return {
            ...
            ids: {
                ...
                ...this.authoredIds(),
                item: (index) => this.#itemAt(index)?.authoredName,
                indicator: (index) => this.#indicatorAt(index)?.authoredName,
            },
    ...
    rootProps(api) {
        ...
        const style = props.style !== null && typeof props.style === "object" ? props.style : {};
        return {
            ...props,
    ...
    indicatorIndexOf(indicator) {
        ...
        if (!this.#indicatorOrder) {
            ...
            for (const candidate of this.#indicators) {
                ...
                const group = findBranded(candidate, CAROUSEL_INDICATOR_GROUP);
    ...
    #translations() {
        const read = (name) => this.getAttribute(`translations-${name}`);
        const translations = {};
...
const RESPONSIVE_ATTRIBUTES = ["slides-per-page", "slides-per-move", "spacing", "padding"];
